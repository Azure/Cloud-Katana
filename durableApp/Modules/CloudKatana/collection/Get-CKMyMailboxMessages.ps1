function Get-CKMyMailboxMessages {
    ...
    .DESCRIPTION
    Get-CKMyMailboxMessages is a simple PowerShell wrapper to read messages from the signed-in user calling the API.
    ...
    .EXAMPLE
    $messages = Get-CKMyMailboxMessages -accessToken $accessToken
    $messages[0]
    ...
    $parameters = @{
        Resource = "me/mailFolders/$mailFolder/messages"
