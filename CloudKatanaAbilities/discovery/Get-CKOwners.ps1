function Get-CKOwners {
    ...
    .DESCRIPTION
    Get-CKOwners is a simple PowerShell wrapper to list ownsers of an application or service principal.
    ...
    .EXAMPLE
    $owners = Get-CKOwners -resourceType 'applications' -objectId xxxxxxxxx -accessToken $accessToken
    $owners
