function Invoke-CKActionRunCommand {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
    Get-CKAzADApplication is a simple PowerShell wrapper to list Azure AD applications.
    ...
    .EXAMPLE
    $apps = Get-CKAzADApplication -accessToken $accessToken
    $apps[0]
    ...
    .EXAMPLE
    $app = Get-CKAzADApplication -appObjectId 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' -accessToken $accessToken
    $app
